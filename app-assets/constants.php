...
// NOTE: the Autoprefixer costs a lot of performance
define('AUTOPREFIXER', true);

// AD_SCRIPT_HEAD files // directory => /js/animation-library
define('AD_SCRIPT_HEAD', '/js/advertiser-scripts/head');
// AD_SCRIPT_BODY files // directory => /js/animation-library
define('AD_SCRIPT_BODY', '/js/advertiser-scripts/body');


// JS_ANIMATION_LIBRARY files // directory => /js/animation-library
define('JS_ANIMATION_LIBRARY', '/js/animation-library');
...
// CLIENT_SCSS BASE FILES // directory => /scss/client-base
define('CLIENT_BASE_SCSS', '/scss/client-base');
