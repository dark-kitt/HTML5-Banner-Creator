<?php
    ...
    require __DIR__ . '/classes/files-and-dir.php';
    require __DIR__ . '/classes/namespaceCSS.php';
    require __DIR__ . '/classes/unusedCSS.php';
    require __DIR__ . '/classes/compressCSS.php';

    get_header();

    $banner_project = new project(json_decode(file_get_contents(dirname(__DIR__) . '/project_config.json')));
...
<main data-project="<?= $banner_project->project_dir ?>">
    ...
    <div class="sidebar sidebar-left" data-sidebar="left">
        <div class="resizable">
            <div class="arrow-con"><img src="<?= set_dir(); ?>img/arrow-dark.svg" alt="arrow"></div>

            <div class="collapsible">
                <div class="collapsible-head" data-files="jstree">
                    <code><xmp><html></projects></xmp></code>
                    <img class="arrow" src="<?= set_dir(); ?>img/arrow-light.svg" alt="arrow">
                </div>
                <div class="collapsible-body">
                    <input id="jstree-search" type="text" value="" placeholder="search..">
                    <img class="refresh" src="<?= set_dir(); ?>img/refresh.svg" alt="refresh" data-files="jstree">
                    <div id="jstree"></div>
                </div>
            </div>
                ...
                foreach ($export_data as $value)
                {
                    printf(
                        '<div class="collapsible">' .
                            ...
                            '</div>' .
                            '<div class="collapsible-body">' .
                                '<img class="refresh" src="' . set_dir() . 'img/refresh.svg" alt="refresh" data-files="%2$s">' .
                                '<ul>' .
