...
{
    require __DIR__ . '/classes/jstree.php';
...
if ( isset( $_POST['export'] ) && !empty( $_POST['export'] ) ||
     ...
     isset( $_POST['changed'] ) && !empty( $_POST['changed'] ) )
 {
     ...
     if ( isset( $_POST['export'] ) && !empty( $_POST['export'] ) )
     {
         ...
         require __DIR__ . '/classes/zip.php';
     ...
     else
     {
         ...
         if ( isset( $_POST['project'] ) && !empty( $_POST['project'] ) )
         {
             ...
             $directories = [];
             helper::get_banner_directories(dirname(__DIR__) . $banner_project->project_dir);
             $data = (object) [
                 'project_dir' => $banner_project->project_dir,
                 'banner_directories' => helper::flatten_array($directories)
             ];
...
{
    require __DIR__ . '/classes/hyphenator.php';
    if ( isset( $_POST['dir'] ) && !empty( $_POST['dir'] ) &&
