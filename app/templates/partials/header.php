<?php
    ...
    require $serverROOT . 'app/vendor/autoload.php';
    ...
    $GLOBALS['scss_compiler']->setImportPaths( [ $serverROOT . 'app/scss' ] );
    $app_css = $GLOBALS['autoprefixer']->compile($GLOBALS['scss_compiler']->compile(file_get_contents($serverROOT . 'app/scss/main.scss')));
...
<html lang="de">
    <head>
        ...
        <link rel="shortcut icon" href="<?= set_dir(); ?>img/favicon.ico">
