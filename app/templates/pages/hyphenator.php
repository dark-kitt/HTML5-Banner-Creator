...
<main class="hyphenator">
    ...
    <div class="head clearfix">
        ...
        <img id="delete-saved-value" src="<?= set_dir(); ?>img/trash.svg" alt="">

        <span>Saved values:
            <select name="saved-values">
                <option value="">choose file</option>
                <?php
                    foreach (helper::custom_glob($serverROOT . 'app/hyphenator-cache', '.json') as $file)
                    {
            ...
            <fieldset>
                ...
                <span>Language:
                    <select name="language" required>
                        <option value="">choose file</option>
                        <?php
                            foreach (helper::custom_glob($serverROOT . 'app/js/vendor/hyphenator-patterns', '.js') as $pattern)
                            {
